...
public class DrawRectangleTest {
    ...
    public void should_throw_exception_for_wrong_coordinates_count() {
        new DrawRectangle(new Request(Character.MIN_VALUE, Lists.newArrayList(1, 2, 3), "c"));
    }

    @Test
    public void should_execute_command() {
        // given
        final Request c = new Request(Character.MIN_VALUE, Lists.newArrayList(1, 2, 3, 4), "c");
